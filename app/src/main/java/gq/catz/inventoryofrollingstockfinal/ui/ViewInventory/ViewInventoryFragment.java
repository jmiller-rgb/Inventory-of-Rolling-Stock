...
public class ViewInventoryFragment extends Fragment {
	...
	public View onCreateView(@NonNull LayoutInflater inflater,
		...
		RecyclerView recyclerView = root.findViewById(R.id.inventoryView);
	...
	private class RecyclerviewAdapter extends RecyclerView.Adapter {
		...
		public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
			//RecyclerViewHolder holder =  new RecyclerViewHolder(LayoutInflater) // TODO: Make listitem layout.
			return null;
		}
